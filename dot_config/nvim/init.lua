...
--  See `:help 'clipboard'`
--  We will use dedicated keymaps for clipboard interaction instead.
...
-- Diagnostic keymaps
-- Since v10 neovim uses <C-W>d to show diagnostics.
...
-- My own keymaps, settings, and autocommands
...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- I changed these mappings because the conflict with 'leap'.
