  ...
  opts = {
    textobjects = {
      ...
      swap = {
        enable = true,
        swap_next = {
          ['<leader>cp'] = '@parameter.inner', -- swap parameters/argument with next
          ['<leader>cf'] = '@function.outer', -- swap function with next
        },
        swap_previous = {
          ['<leader>cP'] = '@parameter.inner', -- swap parameters/argument with prev
          ['<leader>cF'] = '@function.outer', -- swap function with previous
        },
      },
      move = {
        enable = true,
